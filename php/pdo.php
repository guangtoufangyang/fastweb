...
$dataTable = array(
	...
	"tree" => array(array("name" => "branch", "text" => "树干", "leaf" => array(array("name" => "leaf", "link" => "#", "text" => "leaf"), array("name" => "leaf", "link" => "#", "text" => "leaf"),array("name" => "branch", "text" => "树干", "leaf" => array(array("name" => "leaf", "link" => "#", "text" => "leaf"), array("name" => "leaf", "link" => "#", "text" => "leaf"))),array("name" => "branch", "text" => "树干", "leaf" => array(array("name" => "leaf", "link" => "#", "text" => "leaf"), array("name" => "leaf", "link" => "#", "text" => "leaf"))))), array("name" => "branch", "text" => "树干", "leaf" => array(array("name" => "leaf", "link" => "#", "text" => "leaf"), array("name" => "leaf", "link" => "#", "text" => "leaf")))),
